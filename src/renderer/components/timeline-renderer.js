...
export function renderTimeline(items, element, options = {}) {
        ...
        <div class="timeline-card">
          <div class="timeline-card-header">
            ...
            <div class="timeline-card-actions">
              ...
              <button class="delete-item-btn" data-id="${item.id}" data-type="${type}">Delete</button>
            </div>
          </div>
  ...
  const deleteButtons = element.querySelectorAll('.delete-item-btn');
  deleteButtons.forEach(button => {
    button.addEventListener('click', (e) => {
      ...
      if (confirm(`Are you sure you want to delete this ${type} item?`)) {
        // Call the delete function from the parent scope
        if (typeof window.deleteTimelineItem === 'function') {
          window.deleteTimelineItem(id, type);
        }
      }
    });
  });
